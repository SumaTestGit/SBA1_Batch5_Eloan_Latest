...
public class AdminController extends HttpServlet {
	...
	private String calemi(HttpServletRequest request, HttpServletResponse response) throws SQLException {
		 ...
		 * 
		 * int InterestRate = request.getParameter("interest rate"); int TermOfLoan =
		 * request.getParameter("term of loan");
		 * 
		 * Term payment amount = (SanctionedLoanAmount) * (1 + interestRate/100) ^ (term
		 * of loan)
		 * 
